...
let page34 = Page(pageText: "You walk around the woods, searching for a place to spend the night. Occasionally, you see bear prints in muddy patches on the ground, but you easily avoid them. Finally, you spot a nice-looking cave. You enter cautiously, but it appears to be empty. After arranging some dry leaves and moss into a pile, you create a comfortable-looking rest area.")
...
let page61 = Page(pageText: "You wake up in the morning, covered in itchy mosquito bites. When you open your eyes, you spot a large mosquito perched on the end of your nose. You quickly swat it away, fighting the overpowering urge to scratch every inch of exposed skin.")
let page62 = Page(pageText: "...sleep, success")
...
let page101 = Page(pageText: "Congratulations! Your survival skills have paid off, and a rescue party has arrived to bring you back to civilization!")