...
let page10 = Page(pageText: "You gather together some spongy-looking leaves and press them against your wound, desperately hoping that they are not poisonous. The leaves soak up the blood, but now you feel lightheaded. ")
...
let page33 = Page(pageText: "...fire")
let page34 = Page(pageText: "...caught by park rangers")
let page35 = Page(pageText: "...smash")
let page36 = Page(pageText: "...nothing happens")
let page37 = Page(pageText: "...reverse")
let page38 = Page(pageText: "...zzz, stomachache")
let page39 = Page(pageText: "...vomit")
let page40 = Page(pageText: "...stomach rupture")
let page41 = Page(pageText: "...leech blood loss")
let page42 = Page(pageText: "...eaten by bear")
