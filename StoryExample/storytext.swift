...
let page9 = Page(pageText: "You flip a few rocks over. After a while, you have ammassed quite a collection of small fish, worms, and crayfish. You are faintly repulsed by their squirmy, river-dwelling nature, but you are rather hungry. Besides, you've eaten fish and lobsters before. This can't be too different...")
...
let page28 = Page(pageText: "Your mind is set: you won't eat anything but pizza. You search long and hard for a pizza shop, crossing many streams and small hills, but apparently pizza shops don't reside in forests. However, you are determined to find pizza. You push yourself to keep walking and sniffing the air for the unmistakable scent of your favorite food. Eventually, you collapse in exhaustion.")
